...
int main(int argc, char **argv)
{
	...
	std::complex<double> * data3 = new std::complex<double>[total_samples];
    ...
    if(rank == CORE_0)
    {
		...
		sinwave(data2, total_samples, 1, sampling_rate , 0.5);
		sinwave(data3, total_samples, 1, sampling_rate , 0.2);
